...
namespace Client
{
    ...
    public class ClientForm : System.Windows.Forms.Form
    {
        ...
        private OpenEventWrapper wrapper = null;
        ...
        {
            wrapper = new OpenEventWrapper();
            wrapper.EventHandlerA += new OpenEventHandler(wrapper_EventHandlerA);
        ...
        void wrapper_EventHandlerB(string info)
        {
            this.Invoke(new Update(update), info);
        }
